...
## Projetos Práticos da Disciplina (PUC Minas)

Este repositório contém os projetos e as listas de exercícios desenvolvidos na disciplina de Linguagens de Programação, focando na prática dos quatro principais paradigmas de programação.

O objetivo é demonstrar a capacidade de adaptação e a proficiência na aplicação das estruturas, sintaxes e filosofias de diferentes modelos de computação.
